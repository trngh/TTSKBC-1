...
ActiveRecord::Schema.define(version: 2024_07_11_031628) do
  ...
  create_table "e_joins", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["event_id"], name: "index_e_joins_on_event_id"
    t.index ["user_id"], name: "index_e_joins_on_user_id"
  end

  create_table "e_registrations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title"
  ...
  add_foreign_key "e_joins", "events"
  add_foreign_key "e_joins", "users"
  add_foreign_key "e_registrations", "subjects"
  add_foreign_key "e_registrations", "users"
